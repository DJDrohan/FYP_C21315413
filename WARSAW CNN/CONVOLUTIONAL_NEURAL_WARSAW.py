...
# These transforms match your preprocessing (e.g., resizing to 48x48, converting to grayscale)
...
dataset_dir = r"C:\Users\droha\Downloads\COLLEGE\4\FYP\warsaw emotion Data\dropbox-archive\WSEFEP_v101_hq\WSEFEP_v101_hq 2\FOLDERS"
...
num_classes = len(dataset.classes)  # Automatically detected from the subfolders
...
# 8. Real-time Emotion Detection with Webcam (same as before)
def real_time_emotion_detection(model, emotion_mapping):
    ...
    while True:
        ...
        with torch.no_grad():
            ...
            emotion = dataset.classes[predicted_class]  # Class label from ImageFolder

        cv2.putText(frame, f'Emotion: {emotion}', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        for i, (emotion_name, prob) in enumerate(zip(dataset.classes, probabilities)):
...
real_time_emotion_detection(model, dataset.classes)
